...
public class LootTableModifier extends LootModifier {
    ...
    public static final Supplier<com.mojang.serialization.Codec<LootTableModifier>> CODEC = Suppliers.memoize(() ->
    ...
    private static final java.util.Set<String> SKIPPED_LOGGED = new java.util.HashSet<>();
